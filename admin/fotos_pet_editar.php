...
<FORM name='formident' action="script_noticias.php?acao=editar_foto_pet" method='post'>
            ...
            <TABLE class=res-bg cellSpacing=0 cellPadding=0 width=775 
              ...
              <TR>
                ...
                <TD align=middle>
                      ...
                      <TR> 
                        <TD align=middle height=30> 
                          <div align="center"><span class=hm-tab1tx><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Efetue 
                            abaixo a edi&ccedil;&atilde;o dos atributos da imagem.</font></span></div>
                        </TD>
                      </TR>
                      <TR> 
                        <TD> 
					...
					$query = "select * from tbl_galeria where id_galeria = '$id_galeria'";

					$rs = mysql_query($query);

					while ($campo = mysql_fetch_array($rs)){

					$id_galeria = $campo['id_galeria'];
					$titulo            = $campo['titulo'];
				...
				?>
                                                        <table width="500" border="0" align="center" cellpadding="3" cellspacing="3">
                                                          <tr> 
                                                            <td valign="top"> 
                                                              <table width="100%" border="0" cellpadding="3" class="textoPretoBold">
                                                                <tr bgcolor="#DADADA"> 
                                                                  <td width="62%" bgcolor="#DADADA" class="textoMenor"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Título</font></td>
                                                                </tr>
                                                                <tr bgcolor="#DADADA"> 
                                                                  <td bgcolor="#DADADA" class="texto" width="62%"> 
                                                                    <input name="titulo" type="text" class="formu" id="titulo" value="<?= $titulo; ?>" size="55">
                                                                  </td>
                                                                </tr>
																<tr bgcolor="#DADADA"> 
                                                                  <td width="62%" bgcolor="#DADADA" class="textoMenor"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Legenda</font></td>
                                                                </tr>
                                                                <tr bgcolor="#DADADA"> 
                                                                  <td bgcolor="#DADADA" class="texto" width="62%"> 
                                                                    <input name="legenda" type="text" class="formu" id="legenda" value="<?= $legenda; ?>" size="55">
                                                                  </td>
                                                                </tr>
                                                              </table>
                                                            </td>
                                                          ...
                                                          <tr> 
                                                            <td> 
                                                              <div align="center"> 
                                                                <input name="id_galeria" value="<?= $id_galeria; ?>" type="hidden">
