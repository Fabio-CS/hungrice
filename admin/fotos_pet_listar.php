                                                              ...
                                                              <table width="100%" border="0" cellpadding="2" cellspacing="2" class="textoVerdanaPreto">
                                                                <tr bgcolor="#DADADA"> 
                                                                  <td width="10%" bgcolor="#DADADA" > 
                                                                    <div align="left"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Título</font></div>
                                                                  </td>
																  <td width="10%" bgcolor="#DADADA" > 
                                                                ...
                                                                <?
$query = "select * from tbl_galeria_pet order by id_galeria desc";
...
while($row = mysql_fetch_array($rs)){
  ?>
                                                                <tr bgcolor="#F5F5F5"> 
                                                                  ...
                                                                  <td width="13%"> 
                                                                    <div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><a href="fotos_pet_editar.php?id_galeria=<?= $row["id_galeria"] ?>"><img src="imagens/ed_refresh.png" width="16" height="16" border="0"></a></font></div>
                                                                  </td>
                                                                  <td width="12%"> 
                                                                    <div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><a href="script_noticias.php?acao=excluir_foto_pet&id_galeria=<?= $row["id_galeria"] ?>"><img src="imagens/ed_delete.png" width="18" height="17" border="0"></a></font></div>
                                                                  </td>
                                                                </tr>
                                                                <?} ?>
                                                              </table>
