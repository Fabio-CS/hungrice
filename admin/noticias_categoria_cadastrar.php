...
<FORM name='formident' action="script_noticias.php?acao=cadastrar_categoria" method='post'>
                    ...
                    <TABLE cellSpacing=0 cellPadding=0 width=747 border=0>
                      ...
                      <TR> 
                        <TD align=middle height=30> 
                          <div align="center"><span class=hm-tab1tx> <font face="Verdana, Arial, Helvetica, sans-serif" size="1">Cadastre 
                            abaixo uma categoria para a &aacute;rea de not&iacute;cias.</font></span></div>
                        </TD>
                      </TR>
                      <TR> 
                        <TD> 
                              ...
                              width="100%" bgColor=#000000 border=0>
                                  ...
                                  <TR> 
                                    ...
                                    <TD width=665><STRONG><FONT color=#ffffff> 
                                      <font face="Verdana, Arial, Helvetica, sans-serif" size="2">CADASTRO 
                                      DE CATEGORIA</font></FONT></STRONG></TD>
                                  </TR>
                                  </TBODY> 
                                </TABLE>
                              </TD>
                                                              ...
                                                              <table width="100%" border="0" cellpadding="3" class="textoPretoBold">
                                                                ...
                                                                <tr bgcolor="#DADADA"> 
                                                                  <td bgcolor="#DADADA" class="texto" width="62%"> 
                                                                    <input name="categoria" type="text" class="formu" id="categoria" size="55">
                                                                  </td>
                                                                </tr>
                                                              </table>
                                                            </td>
