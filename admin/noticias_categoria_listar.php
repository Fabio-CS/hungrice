                    ...
                    <TR> 
                      <TD align=middle height=30> 
                        <div align="center"><span class=hm-tab1tx><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Verefique 
                          abaixo as categorias de not&iacute;cias cadastradas 
                          no sistema</font></span></div>
                      </TD>
                    </TR>
                    <TR> 
                      <TD> 
                              ...
                              width="100%" bgColor=#000000 border=0>
                                  ...
                                  <TR> 
                                    ...
                                    <TD width=665><STRONG><FONT color=#ffffff> 
                                      ...
                                      AS CATEGORIAS DE NOT&Iacute;CIAS</font> 
                                      </FONT></STRONG></TD>
                                                          ...
                                                          <tr> 
                                                            <td> 
                                                              <table width="100%" border="0" cellpadding="2" cellspacing="2" class="textoVerdanaPreto">
                                                                <tr bgcolor="#DADADA"> 
                                                                  <td width="58%" bgcolor="#DADADA" > 
                                                                    <div align="left"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Categoria</font></div>
                                                                  </td>
                                                                ...
                                                                <?
$query = "select * from tbl_categorias_noticias order by id_categoria_noticia desc";
$rs= mysql_query($query);

while($row = mysql_fetch_array($rs)){
  ?>
                                                                <tr bgcolor="#F5F5F5"> 
                                                                  <td width="58%" bgcolor="#F5F5F5"> 
                                                                    <font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
                                                                    <?= $row["categoria"] ?>
                                                                    </font></td>
                                                                  <td width="13%"> 
                                                                    <div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><a href="noticias_categoria_editar.php?op=editar_categoria&id_categoria_noticia=<?= $row["id_categoria_noticia"] ?>"><img src="imagens/ed_refresh.png" width="16" height="16" border="0"></a></font></div>
                                                                  </td>
                                                                  <td width="12%"> 
                                                                    <div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><a href="script_noticias.php?acao=excluir_categoria&id_categoria_noticia=<?= $row["id_categoria_noticia"] ?>"><img src="imagens/ed_delete.png" width="18" height="17" border="0"></a></font></div>
                                                                  </td>
                                                                </tr>
                                                                <?} ?>
                                                              </table>
