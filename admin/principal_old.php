                            ...
                            align=middle> 
                              ...
                              border=0>
                                ...
                                border=0>
                                      ...
                                      <tr valign=top> 
                                        <td width=25>&nbsp;</td>
                                        <td height=28 width="133"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">NOT&Iacute;CIAS</font></td>
                                      </tr>
                                      </tbody> 
                                    </table>
                                ...
                                border=0>
                                      ...
                                      <tr> 
                                        ...
                                        <td class=hm-tab1tx valign=top width="152"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">• 
                                          <a href="noticias_cadastrar.php"><span class=textos>Cadastrar 
                                          Not&iacute;cia</span></a></font></td>
                                      </tr>
                                      <tr> 
                                        <td width=8>&nbsp;</td>
                                        <td valign=top width="152"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">• 
                                          <a href="noticias_listar.php">Listar Not&iacute;cias</a></font></td>
                                      </tr>
                                      <tr> 
                                        <td width=8>&nbsp;</td>
                                        <td valign=top width="152"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">• 
                                          <a href="noticias_categoria_cadastrar.php"><span class=textos>Cadastrar 
                                          Categoria</span></a></font></td>
                                      </tr>
                                      <tr> 
                                        <td width=8>&nbsp;</td>
                                        <td valign=top width="152"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">• 
                                          <a href="noticias_categoria_listar.php">Listar Categorias</a></font></td>
                                      </tr>
                                      </tbody> 
                                    </table>
                                  </TD>
